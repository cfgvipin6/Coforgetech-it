...
import { removePassword, removeUserName, setLoginType, removeLoginType } from '../auth/AuthUtility';
...
import { AD_LOGIN, APP_LOGIN } from './constants';
import RNExitApp from 'react-native-exit-app';
import { TEMP_URI } from '../auth/constants';
import Crashes from 'appcenter-crashes';
import { writeLog, readIniitianLog } from '../../utilities/logger';
...
class AdLoginScreen extends Component {
  ...
  componentDidMount() {
    SplashScreen.hide();
    focusSubscription = this.props.navigation.addListener('willFocus', this.onFocus);
  ...
  render() {
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View contentContainerStyle={{ flex: 1 }} keyboardShouldPersistTaps="never">
...
export default connect(null, mapDispatchToProps)(AdLoginScreen);
