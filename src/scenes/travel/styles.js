...
export const styles = StyleSheet.create({
  ...
  rowFashion2:{ flexDirection: 'row', justifyContent: 'space-between' , alignItems:'center'},
  ...
  textSix:{
    ...
    cardStyle:{ flex: 0, marginHorizontal: moderateScale(6), paddingTop: moderateScale(2) },
